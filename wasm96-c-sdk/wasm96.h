...
extern void wasm96_input_set_mode(uint32_t mode) WASM96_WASM_IMPORT("env", "wasm96_input_set_mode");
...
static inline void wasm96_input_set_mode_enum(wasm96_input_mode_t mode) {
    wasm96_input_set_mode((uint32_t)mode);
}
